...
from neuroflow.inference.sr_uq_common import (
    _read_case_volumes,
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "(original, residual_skip, pre_res_attention, pre_upsample_attention). "
    ...
    parser.add_argument(
        ...
        default=None,
        help=(
            "Optional override for the auxiliary segmentation head. Default: inferred "
            "from the checkpoint. --cascade-use-seg-head is a deprecated alias."
        ),
    )
    ...
    meta = {
        ...
        "use_seg_head": bool(getattr(model, "use_seg_head", False)),
        "case_paths": {
            "lr_u": case.get("lr_u", ""),
            "lr_v": case.get("lr_v", ""),
            "lr_w": case.get("lr_w", ""),
