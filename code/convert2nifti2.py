...
if __name__ == "__main__":
    ...
    parser.add_argument("--input-root", default="../data/sorted_patients", help="Root folder containing per-patient DICOM folders")
    parser.add_argument("--output-root", default="../data/nifti_patients", help="Destination folder for per-patient NIfTI outputs")
