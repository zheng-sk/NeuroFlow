...
class nnUNetTrainerSkeletonRecallDA5(nnUNetTrainerDA5):
    def __init__(self, plans: dict, configuration: str, fold: int, dataset_json: dict, unpack_dataset: bool = True,
                 device: torch.device = torch.device('cuda')):
        super().__init__(plans, configuration, fold, dataset_json, unpack_dataset, device)

        self.weight_srec = 1.0  # This is the default value, you can change it if you want
        self.weight_ce = 1.0  # This is the default value, you can change it if you want
        self.weight_dice = 1.0  # This is the default value, you can change it if you want
    ...
    def _build_loss(self):
        loss = DC_SkelREC_and_CE_loss(soft_dice_kwargs={'batch_dice': self.configuration_manager.batch_dice, 
                                      ...
                                      soft_skelrec_kwargs={'batch_dice': self.configuration_manager.batch_dice, 
                                                           'smooth': 1e-5, 'do_bg': False, 'ddp': self.is_ddp}, 
                                      ce_kwargs={}, weight_ce=self.weight_ce, weight_dice=self.weight_dice,
